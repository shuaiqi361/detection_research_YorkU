...
class SSD512(nn.Module):
    ...
    def __init__(self, n_classes, device='cuda:0'):
    ...
    @staticmethod
    def disable_parameter_requires_grad(m):
    ...
    def forward(self, image):
        ...
        conv4_3_feats, conv5_3_feats, conv7_feats = self.base(image)  # (N, 512, 64, 64), (N, 1024, 32, 32), (N, 1024, 16, 16)
