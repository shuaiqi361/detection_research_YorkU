...
class MultiBoxLoss300(nn.Module):
    ...
    def __init__(self, priors_cxcy, threshold=0.5, neg_pos_ratio=3, alpha=5., device='cuda:1'):
    ...
    def forward(self, predicted_locs, predicted_scores, boxes, labels):
        ...
        loc_loss = self.Diou_loss(decoded_locs[positive_priors], true_locs[positive_priors])
